                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          padding: EdgeInsets.all(5), // 안쪽
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 10), // 바깥쪽
                          decoration: BoxDecoration(
                        ...
                        Text('서울 광진구',
                            style: TextStyle(
                                ...
                                fontFamily: "Pre")),
                        Container(
                          padding: EdgeInsets.all(6), //안쪽
                          margin: EdgeInsets.fromLTRB(0, 8, 0, 5), // 바깥쪽
                          height: 30,
                          width: 90,
                          decoration: BoxDecoration(
                            color: Color(0xffF8F8F8),
